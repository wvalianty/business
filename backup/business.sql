...
MySQL - 5.7.15-log : Database - business
*********************************************************************
*/
...
CREATE TABLE `company` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '结算公司，id',
  `company_name` varchar(100) DEFAULT NULL COMMENT '公司名称',
  `sort` smallint(6) DEFAULT '100' COMMENT '排序，倒序',
  PRIMARY KEY (`id`)
...
CREATE TABLE `invoice` (
  ...
  `status` tinyint(4) DEFAULT NULL COMMENT '0未开票、1已开票,2不开票',
  `is_delete` tinyint(1) DEFAULT '0' COMMENT '是否已删除',
  PRIMARY KEY (`id`),
...
CREATE TABLE `users` (
  ...
  `role` int(8) unsigned NOT NULL COMMENT '1:管理员,2:财务侧,3:运营侧',
